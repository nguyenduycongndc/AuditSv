...
{
    public partial class AuditWorkScopePlanFacility : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AUDIT_WORK_SCOPE_PLAN_FACILITY",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AUDIT_WORK_SCOPE_PLAN_FACILITY", x => x.id);
                    table.ForeignKey(
                        name: "FK_AUDIT_WORK_SCOPE_PLAN_FACILITY_AUDIT_WORK_PLAN_auditwork_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AUDIT_WORK_SCOPE_PLAN_FACILITY_auditwork_id",
