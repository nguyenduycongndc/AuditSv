...
namespace Audit_service.Migrations
{
    ...
    [Migration("20211123070614_AuditRequestMinitorUpdate")]
    partial class AuditRequestMinitorUpdate
    {
            ...
            modelBuilder.Entity("Audit_service.Models.MigrationsModels.AuditDetect", b =>
                {
                    ...
                    b.Property<int?>("control_assessment_id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Audit_service.Models.MigrationsModels.AuditRequestMonitor", b =>
                {
                    ...
                    b.Property<int?>("audit_request_type_id")
                        .HasColumnType("integer")
                        .HasColumnName("audit_request_type_id1");

                    b.Property<int?>("auditrequesttypeid")
                        .HasColumnType("integer")
                        .HasColumnName("audit_request_type_id");

                    b.Property<int?>("detect_id")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("audit_request_type_id");

                    b.HasIndex("detect_id");
            ...
            modelBuilder.Entity("Audit_service.Models.MigrationsModels.AuditRequestMonitor", b =>
                {
                    b.HasOne("KitanoUserService.API.Models.MigrationsModels.Category.CatAuditRequest", "CatAuditRequest")
                        .WithMany()
                        .HasForeignKey("audit_request_type_id");

                    b.HasOne("Audit_service.Models.MigrationsModels.AuditDetect", "AuditDetect")
                        .WithMany("AuditRequestMonitor")
                        .HasForeignKey("detect_id");
